// system params
let project_flr = "public/assets";
let source_flr = "resources";
...
let path = {
    build: {
        html: project_flr + "/",
        css: project_flr + "/template/css/",
        js: project_flr + "/template/js/",
        img: project_flr + "/template/images/",
        fonts: project_flr + "/template/fonts/",
        libs: project_flr + "/template/libs/",
        svg: project_flr + "/template/images/svg/",
    },
    src: {
        html: source_flr + "/html/*.html",
        css: source_flr + "/scss/style.scss",
        js: source_flr + "/js/app.js",
